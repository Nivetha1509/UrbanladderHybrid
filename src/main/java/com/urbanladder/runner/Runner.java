...
public class Runner {
	...
	void qapage() throws IOException, InterruptedException {
		driver.get(PropertyFileReader.loadFile().getProperty("url"));
			...
			qandapageobject.qa(driver, PropertyFileReader.loadFile().getProperty("data"), PropertyFileReader.loadFile().getProperty("data2"), log);
	...
	void signup() throws IOException, InterruptedException {
		driver.get(PropertyFileReader.loadFile().getProperty("url"));
			...
			signinpageobject.search(driver, PropertyFileReader.loadFile().getProperty("email"), PropertyFileReader.loadFile().getProperty("password"), log);
	...
	void subscription() throws IOException, InterruptedException {
		driver.get(PropertyFileReader.loadFile().getProperty("url"));
			...
			subscriptionpageobject.subscription(driver,PropertyFileReader.loadFile().getProperty("email") , PropertyFileReader.loadFile().getProperty("data3"), log);
	...
	void track() throws IOException, InterruptedException {
		driver.get(PropertyFileReader.loadFile().getProperty("url"));
			...
			trackorderpageobject.track(driver, PropertyFileReader.loadFile().getProperty("orderno"), PropertyFileReader.loadFile().getProperty("phonenumber"), log);
